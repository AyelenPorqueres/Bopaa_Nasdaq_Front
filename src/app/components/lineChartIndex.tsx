...
//Realizo una función para generar colores aleatorios de los indices.
...
//Obtengo y proceso los datos del grafico desde la API.
const fetchChartData = async (dias: number, setChartData: React.Dispatch<React.SetStateAction<ChartData | null>>, setLoading: React.Dispatch<React.SetStateAction<boolean>>) => {
    ...
    //Llamo a la API para obtener los datos
    try {
        console.log(dias)
...
//Componente principal del grafico donde incorporo un efecto para actualizar los datos 
